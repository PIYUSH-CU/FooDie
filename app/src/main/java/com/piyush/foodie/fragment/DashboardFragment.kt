package com.piyush.foodie.fragment
...
import com.piyush.foodie.adapter.DashboardFragmentAdapter
import com.piyush.foodie.model.Restaurant
import com.piyush.foodie.utils.ConnectionManager
    ...
    override fun onCreateView(
        ...
        fun filterFun(strTyped: String) {
            ...
            for (item in restaurantInfoList) {
                if (item.restaurantName.lowercase(Locale.ROOT)
...
//                        if (radioButtonView.high_to_low.isChecked) {
//                            Collections.sort(restaurantInfoList, costComparator)
//                            restaurantInfoList.reverse()
//                            dashboardAdapter.notifyDataSetChanged()
//                        }
//                        if (radioButtonView.low_to_high.isChecked) {
//                            Collections.sort(restaurantInfoList, costComparator)
//                            dashboardAdapter.notifyDataSetChanged()
//                        }
//                        if (radioButtonView.top_rating.isChecked) {
